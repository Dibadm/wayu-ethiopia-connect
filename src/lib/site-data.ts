...
export const coffeeGrades = [
  {
    name: "Grade 1 Washed Arabica",
    process: "Washed",
    detail:
      "Fully washed, hand-sorted lots with tight defect counts for specialty and premium commercial buyers.",
    attributes: ["Screen 15+ available", "Low defect count", "Lot traceability"],
  },
  {
    name: "Grade 2 Washed Arabica",
    process: "Washed",
    detail:
      "Consistent washed profile for volume programmes where cup character and price must stay balanced.",
    attributes: ["Volume programmes", "Repeatable profile", "Contract friendly"],
  },
  {
    name: "Grade 1 Natural / Sun-Dried",
    process: "Natural",
    detail:
      "Sun-dried on raised beds, delivering the fuller body and fruit-forward character natural lots are sourced for.",
    attributes: ["Raised-bed drying", "Fruit-forward", "Origin documented"],
  },
  {
    name: "Grade 2 Natural / Sun-Dried",
    process: "Natural",
    detail:
      "Commercial natural lots prepared for reliable container-scale shipment schedules.",
    attributes: ["Container scale", "Stable supply", "Cost efficient"],
  },
];

export const agriCommodities = [
  "Oil seeds (sesame, niger seed)",
  "Pulses (chickpea, red kidney bean)",
  "Spices & herbs",
  "Other agricultural commodities on request",
];
